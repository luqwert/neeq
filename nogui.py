...
def run():
    ...
    companyCd = cf.get("config", 'companyCd').strip()
    companyName = cf.get("config", 'companyName').strip()
    startTime = cf.get("config", 'startTime').strip()
    endTime = cf.get("config", 'endTime').strip()
    receiveMail = cf.get("config", 'receiveMail').strip()
    # print(companyCd)
    # print(companyName)
    # print(startTime)
    # print(endTime)
